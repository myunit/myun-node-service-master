        ...
        [
          ...
          function (order, cb) {
            if (data.type === 3) {
              ...
              package.deliverDate = utils.formatByT(new Date(end.valueOf() + 4*24*60*60*1000));
        ...
        accepts: [
          {
            ...
            description: [
              ...
              'userId:用户编号, receiverId:收货地址编号, logistics:物流(快递 or 自提), message:留言, type:订单类型(0-普通订单,3-包团订单, 5-拼团), ',
